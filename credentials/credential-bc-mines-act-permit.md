...
The Chief Permitting Officer (CPO) is the governing authority responsible for this Governance Framework (GF). The Chief Permitting Officer is defined in section 8.2 of [the Mines Act](https://www.bclaws.gov.bc.ca/civix/document/id/complete/statreg/96293_01#section8.2). The CPO may delegate in writing to an inspector any of the powers conferred on the CPO under this Act.
