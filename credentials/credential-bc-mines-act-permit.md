...
--- | --- | --- | --- | --- |
Notice of Work | notice_of_work_type | String | not NULL | Applications are assigned a Notice of Work. A Notice of Work is a unique identifier assigned to a mining operation or mine site. These are used to identify Regional Mines and may not always be applicable for Major Mines. Multiple Notices of Work can be included within one permit. Each Notice of Work has its own unique Latitude and Longitute. All previous Notices of Work are included as a history within the permit.
