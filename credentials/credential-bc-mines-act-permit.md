...
Permit Issuer| permit_issuer | String | not NULL | Permit Issuer can be the Deputy Chief Permitting Officer (DPO) as delegated authority by the Chief Permitting Officer (CPO). Inspector of Mines Permitting and Senior Inspector of Mines Permitting also have the authority of Permit Issuer. The act defines a Permit Issuer as an individual designated by the regulatory authority to authorize permit status. [Mines Act Section 8.3] (https://www.bclaws.gov.bc.ca/civix/document/id/complete/statreg/96293_01#section8.2)(IN ALL THE EXAMPLE PERMITS INSPECTOR OF MINES OR SENIOR INSPECTOR OF MINES IS WHAT IS COMMONLY USED)
