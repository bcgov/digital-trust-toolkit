...
Permit Issuer| permit_issuer | String | not NULL | The person who has delegated authority from regulation - see [Mines Act Section 8.3](https://www.bclaws.gov.bc.ca/civix/document/id/complete/statreg/96293_01#section8.2) Field is captured within Regional Mines. This field is not captured for Major Mines Permits. If no name is specified, title will default to Chief Permitting Officer or relevant delegated authority. 
