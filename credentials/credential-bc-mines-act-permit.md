...
--- | --- | --- | --- | --- |
Notice of Work | notice_of_work_type | String | not NULL | Applications assigned a notice of work = A unique identifier assigned to a mining operation or mine site. These are used to identify Regional Mines and may not be applicable for Major Mines. Multiple notices of work can be housed within one permit. Each notice of work has its own unique Latitude and Longitute. All previous Notices of Work with their own unique latitude and longitudes are included as a history within the permit.
...
Mine Status | mine_status | String | not NULL | Describes a specific mine's operational status over time. 
...
Permit Conditions | permit_conditions | String | not NULL | Contains the set of conditions for a draft permit. Permit conditions are only available for regional permits and permit amendments that have been issued through Core since January 2021.
