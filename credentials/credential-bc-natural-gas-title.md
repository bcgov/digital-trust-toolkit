...
date_expiry | String | not Null | Expiry date is defined as effective date plus term, expressed as YYYY/MM/DD.
containing | String | not Null | This section refers to what is contained within a specific title. Certain limitations apply in specific circumstances. 
lessee| String | not Null | Petroleum and Natural Gas Act Section 50(1) and (2) outlines Leasee(s) and their rights. Section 1 outlines lessee as "a person in whose name a lease is recorded in the divisions records". the same section also states that “holder of a location means, in accordance with the context, a permittee, licensee, or lessee.”
